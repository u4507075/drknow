 ...
 * @author Piyapong
 */
@WebServlet(name = "Selectfeature", urlPatterns = {"/Selectfeature"})
public class Selectfeature extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        db.init();
        db.selectfeature(request.getSession().getAttribute("userid").toString(), 
