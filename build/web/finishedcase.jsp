...
<html>
    ...
    <body ng-controller="MainCtrl">
        <div id="finishedcasecontent"></div>
        <script>
            /*
            $( document ).ready(function() {
                //document.title = $( "div.title" )[0].text();
                
                $("#finishedcasecontent").append(sessionStorage.getItem("htmlcontent"));
                $('button.myButton').remove();
                //document.title = $("#finishedcasecontent").find('.title')[0].html();
                document.title = $("div.title:first").text();
            });*/
            $( document ).ready(function() {
                $.ajax({      
                    type:'POST',
                    url: 'Finishedcase',                      
                    data: {caseid: sessionStorage.getItem("finishedcaseid")},
                    dataType: 'text',     
                    beforeSend: function() {
                    ...
                    success: function(result){
                        ...
                        $("#finishedcasecontent").append(result);
                        $('button.myButton').remove();
                        //document.title = $("#finishedcasecontent").find('.title')[0].html();
                        document.title = $("div.title:first").text();
                        },
